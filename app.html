// ------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------
    // Insult Slot Machine — a just-for-fun feature. Spins three reels,
    ...
    async function spinSlotMachine() {
      ...
      if (!players.length) {
        slotErrorEl.textContent = "Add at least one active player before using the Insult Slot Machine.";
        return;
      }
